...
class SolidMaterial(Configuration, Material):
    ...
    # Economic Properties
    ecost_per_kg:float = attr.ib(default=1.0)  # dollar per kg
...
class SS_316(SolidMaterial):
    ...
    # Economic Properties
    ecost_per_kg:float = attr.ib(default=3.26)  # dollar per kg
...
class ANSI_4130(SolidMaterial):
    ...
    # Economic Properties
    ecost_per_kg:float = attr.ib(default=2.92)  # dollar per kg
...
class ANSI_4340(SolidMaterial):
    ...
    # Economic Properties
    ecost_per_kg:float = attr.ib(default=2.23)  # dollar per kg
...
class Aluminum(SolidMaterial):
    ...
    # Economic Properties
    ecost_per_kg:float = attr.ib(default=1.90)  # dollar per kg
...
class Concrete(SolidMaterial):
    ...
    # Economic Properties
    ecost_per_kg:float = attr.ib(default=95.44 / 1000.0)  # dollar per kg
...
class DrySoil(SolidMaterial):
    ...
    # Economic Properties
    ecost_per_kg:float = attr.ib(default=44.78 / 1000.0)  # dollar per kg
...
class WetSoil(SolidMaterial):
    ...
    # Economic Properties
    ecost_per_kg:float = attr.ib(default=34.44 / 1000.0)  # dollar per kg
...
class Rubber(SolidMaterial):
    ...
    # Economic Properties
    ecost_per_kg:float = attr.ib(default=40.0 / 1000.0)  # dollar per kg
