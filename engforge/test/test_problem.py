...
class TestSession(unittest.TestCase):
    ...
    def test_slide_crank_design_one_match(self):
        ...
        self.assertEqual(
            chk(atx, "solver.var"),
            set(("Lo", "Rc", "Ro", "x_offset", "y_offset", "X_spring_center")),
        )
    ...
    def test_slide_crank_design_slv(self):
        ...
        pbx = ProblemExec(
            sm,
            {
                "combos": "design,cost,speed_goal,range_goal",
                "ign_combos": "max*",
                "slv_vars": "*slv",
                "dxdt": None,
            },
    ...
    def test_slide_crank_add_var(self):
        sc = SliderCrank()
        out = sc.run(
            combos="design,speed_goal,range_goal",
            slv_vars="*",
            revert_last=False,
            add_vars="*gear*",
            both_match=False,
            ...
            with ProblemExec(tst) as pb1:
                ...
                with ProblemExec(tst, level_name="2") as pb2:
                    ...
                    with ProblemExec(tst) as pb3:
                        ...
                        raise TestError(
                            "pocket-sand"
                        )  # TODO: INSERT KING OF THE HILL REFERENCE
